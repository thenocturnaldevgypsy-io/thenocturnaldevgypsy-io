...
↦ 🧪 : Currently exploring AI Text to Image Prompts, Learning more about Crypto & NFTs, Catching up with Frontend & Backend technologies ATM (& some [Code Challenges](https://github.com/thenocturnaldevgypsy-io/code_challenges) too). Planning to start three open source projects: Static Page Generator, Font Library for Crypto, Link in Bio CMS. Loving GitHub [Projects](https://github.com/thenocturnaldevgypsy-io?tab=projects) ATM too.
